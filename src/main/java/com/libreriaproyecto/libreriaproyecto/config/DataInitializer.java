...
public class DataInitializer implements CommandLineRunner {
    ...
    private void loadData() {
        ...
        List<Libro> libros = Arrays.asList(
            new Libro("Cien años de soledad", autores.get(0), categorias.get(0), 9.99,"img/cien.jpg"),
            new Libro("Harry Potter y la piedra filosofal", autores.get(1), categorias.get(3), 8.50,"img/harry.jpg"),
            new Libro("1984", autores.get(2), categorias.get(1), 5.99,"img/1984.jpg"),
            new Libro("La casa de los fantasmas", autores.get(3), categorias.get(0), 15.39,"img/casa.jpg.png"),
            new Libro("El resplandor", autores.get(4), categorias.get(2), 10.99,"img/resplando.jpg")
        );
